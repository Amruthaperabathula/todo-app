...
export const getToggleTodoUrl = (id: number,) => {
 ...
 */
export const toggleTodo = async (id: number, options?: RequestInit): Promise<Todo> => {

  return customFetch<Todo>(getToggleTodoUrl(id),
  {
    ...options,
    method: 'PATCH'
...
export const getToggleTodoMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof toggleTodo>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof toggleTodo>>, TError,{id: number}, TContext> => {

const mutationKey = ['toggleTodo'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof toggleTodo>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  toggleTodo(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ToggleTodoMutationResult = NonNullable<Awaited<ReturnType<typeof toggleTodo>>>

    export type ToggleTodoMutationError = ErrorType<void>

    /**
 * @summary Toggle todo completion status
 */
export const useToggleTodo = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof toggleTodo>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getToggleTodoMutationOptions(options));
    }
